...
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY   "High-performance C++20 library with cross-platform 128-bit integer and high-precision decimal arithmetic")
...
if("WIX" IN_LIST CPACK_GENERATOR AND WIN32)
	...
	file(WRITE "${CPACK_WIX_PATCH_FILE}"
		...
		"<CPackWiXPatch>\n"
		"  <CPackWiXFragment Id=\"CM_CP_bin.nfx_datatypes.dll\">\n"
